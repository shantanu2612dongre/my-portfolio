...
const navItems = [
  { label: "Resume", href: "/SHANTANU_DONGRE_PMResume.pdf", isResume: true },
...
const Header = () => {
  ...
  // Open resume in new tab using window.open to bypass React Router
  const openResume = () => {
    window.open("/SHANTANU_DONGRE_PMResume.pdf", "_blank");
  };
    ...
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex md:hidden items-center">
          <ThemeSwitcher />
          <Button variant="ghost" size="icon" className="ml-2 text-white" onClick={toggleMobileMenu}>
