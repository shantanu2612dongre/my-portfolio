...
const experiences = [
  {
    ...
    description: [
      ...
      "Partnered with UI/UX teams to review wireframes and prototypes, identifying usability issues early in the product lifecycle.",
            ...
            {experiences.map((experience, index) => (
              <Card key={index} className="bg-black/10 border border-gray-200 shadow-sm text-black backdrop-blur-sm p-4 rounded-md">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-800 mb-3">{experience.company}</p>
                  <ul className="space-y-2 ml-4 list-disc marker:text-gray-400 text-sm">
